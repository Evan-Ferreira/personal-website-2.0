...
const SideQuestRight = () => {
    return (
        <div className="w-full h-64 overflow-hidden relative group">
            <div className="z-10 absolute left-0 top-0 h-full w-1/3 flex flex-col justify-between py-4 px-4 opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 ease-in-out duration-300 pointer-events-none group-hover:pointer-events-auto">
            ...
            ></div>
            <div className="absolute inset-0 hover:bg-gradient-to-l from-[#2A2A2A]/50 to-[#2A2A2A]"></div>
        </div>
    );
};
