...
const Article = () => {
    return (
        ...
        >
            ...
            <SmallSpacer />
            <P>
                Ever since, I’ve been determined to break into tech and have
                done pretty well this past year. I’ve worked as a software
                engineer at two early stage companies, sold my AI startup, and
                just landed an internship offer from Shopify.
            </P>
            <Spacer />
            <P className="font-bold">
                <strong>
                    Here's a secret—I still don't know shit about tech.
                </strong>
            </P>
            <Spacer />
            <P>
                I'm all about taking action first and figuring it out along the
                way, but the downside to this approach has been I've prioritized
                landing jobs over mastering fundamental concepts. For example:
            </P>
            <SmallSpacer />
            <P>
            ...
            <P>
                ...
                Shopify, I find myself in a unique "limbo" period for once–I’m
                not scrambling to find another job. This summer, I'm using this
                breathing room to master the basics of full-stack development.{' '}
            </P>
            <SmallSpacer />
            <P>
                This is a living article that I’ll use to document my journey to
                becoming a 10x engineer: what resources I use, what's effective,
                and what I learned.
            </P>
            <SmallSpacer />
